...
<head>
  ...
  <script src="/PalchikiStudio/js/phonemask.js"></script>
  ...
  <div class="container">
    ...
    <footer>
      <ul class="contactInfo">
        ...
        <li class="contacts">Мы в Инстаграме<br><a href="https://www.instagram.com/palchikistudio/" class="social-btn social-btn-ig"><img src="/PalchikiStudio/resources/images/insta.png" width="45" height="35" alt="Инстаграм"></a></li>
      </ul>
    </footer>

    <div class="phone"><img src="/PalchikiStudio/resources/images/phone_green.png"></div>
